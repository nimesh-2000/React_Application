...
export default function OrdersCart(props) {
  ...
  // console.log(e);
  const handleCheckout = async (itemCode,itemCategory, itemName, qty, amount) => {
 ...
 <Button variant="outlined" href="#outlined-buttons"  onClick={() => handleViewOrders(email)}>
          ...
          <TableBody>
            {orders.map((order) => (
              <StyledTableRow key={order}>
                ...
                <StyledTableCell align="right">{order.itemCategory}</StyledTableCell>
      ...
      {orders.map((order) => (
        <Button type="submit" onClick={() => {
          handleCheckout(order.itemCode,order.itemCategory, order.itemName, order.qty, order.amount)
